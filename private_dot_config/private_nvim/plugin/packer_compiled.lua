...
_G.packer_plugins = {
  ...
  neogit = {
    loaded = true,
    path = "/home/thynkon/.local/share/nvim/site/pack/packer/start/neogit",
  ...
  ["nvim-gps"] = {
    loaded = true,
    path = "/home/thynkon/.local/share/nvim/site/pack/packer/start/nvim-gps",
  ...
  ["one-nvim"] = {
    loaded = true,
    path = "/home/thynkon/.local/share/nvim/site/pack/packer/start/one-nvim",
  ...
  ["vim-endwise"] = {
    loaded = true,
    path = "/home/thynkon/.local/share/nvim/site/pack/packer/start/vim-endwise",
